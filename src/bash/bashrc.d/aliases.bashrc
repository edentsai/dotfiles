...
# Bashrc configuration for aliases.

# Add aliases for shorten commands.
function bashrc::aliases_for_shorten_commands()
{
    alias c="clear"
    alias cls="clear"
    alias d="dir"
...
# Add aliases for dangerous commands with prompt.
function bashrc::aliases_for_dangerous_commands_with_prompt()
{
...
# Add aliases for commands with default options.
function bashrc::aliases_for_commands_with_default_options()
{
...
function bashrc::useful_aliases()
{
